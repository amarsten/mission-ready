...
(function($, videojs, undefined) {
   ...
   var defaultSetting = {
      markerStyle: {
         ...
         'z-index': 100,
         'border': '1px solid rgba(217, 226, 235, 0.5)'
      },
      markerTip: {
         display: true,
   ...
   function registerVideoJsMarkersPlugin(options) {
         ...
         $.each(newMarkers, function(index, marker) {
            ...
            videoWrapper.find('.vjs-progress-control').append(markerDiv);
               ...
               if (setting.markerTip.display) {
                  initializeMarkerTip(markerDiv);
               }

            // store marker in an internal hash map
            // markersMap[marker.key] = marker; // MOVED THIS UP IN THE FUNCTION
      ...
      function registerMarkerTipHandler(markerDiv) {
        ...
        //
        // // console.log(getPosition(marker))
        ...
        //                "visibility"  : "visible"});
        // console.log(markersMap[$(markerDiv).data('marker-key')])
      ...
      function initializeMarkerTip(markerDiv) {
        var marker = markersMap[$(markerDiv).data('marker-key')];
